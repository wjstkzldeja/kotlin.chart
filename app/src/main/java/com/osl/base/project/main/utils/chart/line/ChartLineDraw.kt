...
import com.osl.base.project.main.views.chart.line.ChartLineViewModel
import timber.log.Timber.Forest.d


class ChartLineDraw(context: Context?, attrs: AttributeSet?) :
    View(context, attrs) {
    private var touchIndex: Int = 0
    lateinit var viewModel: ChartLineViewModel
    ...
    private fun moveLastScroller() {
        ...
        xPointList.last().let { lastValue ->
            ...
            viewModel.axisScrollEvent(scrollByX)
